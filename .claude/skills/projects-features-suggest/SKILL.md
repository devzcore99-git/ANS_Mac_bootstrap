...
description: >-
  ...
  could grow into, wants a roadmap, or wants to see the ideas already proposed.
---
...
root does not exist and links resolve to nothing.

**A copy scopes itself to the repository it sits in.** Without `skills_config.json`
the script falls back to the repository it was copied into.
